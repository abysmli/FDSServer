...
import com.fds.server.controller.FaultController;
import com.fds.server.model.DatabaseHandler;

@Path("/")
public class FDSSimulatorController {
	...
	public String welcomeFDS() {
		return "<html><title>FDS Server Backend</title><link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=Jura'><body><p style=\"margin-top:3em; text-align:center; font-size: 4em; font-family: 'Frutiger', serif;\">Welcome to FDS Server System!</p><p style='text-align:center;'>Cataline Base: "+System.getProperty("catalina.base")+ "</p></body></html>";
	}
