...
public class FRSGUIRouter {
    ...
    public Response resetDatabase() throws JSONException, NamingException, SQLException {
        JSONObject resultSystemDatabase = databaseSystem.resetDatabase();
        JSONObject resultFaultDatabase = databaseFault.resetDatabase();
        JSONArray result = new JSONArray();
        result.put(resultSystemDatabase);
        result.put(resultFaultDatabase);
    ...
    @Path("/getSymptomAirpressure")
    @GET
    @Produces("application/json;charset=utf-8")
    public Response getSymptomAirpressure() throws JSONException, NamingException, SQLException {
        JSONArray symptoms = databaseSymptom.getSymptomAirpressure();
        return Response.status(200).entity(symptoms.toString()).build();
    }

    @Path("/getSymptomHeating")
    @GET
    @Produces("application/json;charset=utf-8")
    public Response getSymptomHeating() throws JSONException, NamingException, SQLException {
        JSONArray symptoms = databaseSymptom.getSymptomHeating();
        return Response.status(200).entity(symptoms.toString()).build();
    }

    @Path("/getSymptomInflow")
    @GET
    @Produces("application/json;charset=utf-8")
    public Response getSymptomInflow() throws JSONException, NamingException, SQLException {
        JSONArray symptoms = databaseSymptom.getSymptomInflow();
        return Response.status(200).entity(symptoms.toString()).build();
    }

    @Path("/getSymptomPumping")
    @GET
    @Produces("application/json;charset=utf-8")
    public Response getSymptomPumping() throws JSONException, NamingException, SQLException {
        JSONArray symptoms = databaseSymptom.getSymptomPumping();
        return Response.status(200).entity(symptoms.toString()).build();
    }
